...
```bash
sudo apt install -y git && git clone https://github.com/raultocantins/instalador-chat.git instalador && sudo chmod -R 777 ./instalador && cd ./instalador && sudo ./install_primaria
```
